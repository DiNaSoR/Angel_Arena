...
function 	GameMode:InitGameMode()
				...
				print( "Angel Arena InitGameMode is Loaded." )
				...
				LinkLuaModifier( "modifier_stun_lua", "Abilities/modifier_stun_lua.lua", LUA_MODIFIER_MOTION_NONE )
...
function GameMode:OnEntityKilled(keys)
	...
	--end
	 ...
	 if killedUnit:IsCreature() or killedUnit:IsCreep() then
	 	print ("KILLEDKILLER: " .. killedUnit:GetUnitName() .. " -- " .. killerEntity:GetUnitName())
